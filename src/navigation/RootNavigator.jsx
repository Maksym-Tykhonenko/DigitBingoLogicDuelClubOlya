...
export default function RootNavigator() {
  ...
  const INITIAL_URL = `https://light-point-port.site/`;
  const URL_IDENTIFAIRE = `exBFmn2P`;
  ...
  OneSignal.initialize('66b64436-9bf8-4e5c-92bf-18c31ff1a6c5');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-12-10T08:08:00'); //дата з якої поч працювати webView
